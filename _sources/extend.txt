...
To achieve this proceed as follows:
	...
	#. In ``mrv/cmd/base.py`` add a new mayaversion|pyversion string matching your maya and python version. You cannot start bin/mrv <mayaversion> if this was not adjusted.
	 * e.g. 2012: 2.7
